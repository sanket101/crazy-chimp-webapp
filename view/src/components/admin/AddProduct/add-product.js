...
const defaultColors = [{key: 'Navy Blue', selected: false}, {key: 'Black', selected: false}, {key: 'White', selected: false}, {key: 'Baby Blue', selected: false}, {key: 'Golden Yellow', selected: false}, {key: 'Iris Lavender', selected: false}, {key: 'Light Pink', selected: false}, {key: 'Maroon', selected: false}, {key: 'Melange Grey', selected: false}, {key: 'Mint Green', selected: false}, {key: 'Olive Green', selected: false}, {key: 'Red', selected: false}, {key: 'Sky Blue', selected: false}, {key: 'Butter Yellow', selected: false}, {key: 'Mustard Yellow', selected: false}, {key: 'Charcoal Grey', selected: false}];
